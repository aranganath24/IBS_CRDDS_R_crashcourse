...
1.  In an R Project, the working directory is automatically set to the root of the R Project directory, and files can be read into the R environment in scripts that use file paths relative to the root directory
